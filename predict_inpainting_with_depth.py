...
def main(
    ...
    input_video, input_video_mask = get_video_to_video_latent_with_depth(
        validation_video,
        camera_pose_file,
        video_length,
        sample_size,
...
if __name__ == '__main__':
    ...
    transformer_path = "output_dir_20250123_inpainting_with_depth_attn1_head/checkpoint-8038/transformer/diffusion_pytorch_model.safetensors"
    depth_anything_path = "output_dir_20250123_inpainting_with_depth_attn1_head/checkpoint-8038/dav2/depth_anything.pth"
    dav2_outdoor = True
    dav2_model = 'vits'
    ...
    camera_pose_file = os.path.join(data_path, data['camera_file_path'])
    prompt = data['text']
    ...
    save_path = "output_dir_20250123_inpainting_with_depth_attn1_head/sample"
